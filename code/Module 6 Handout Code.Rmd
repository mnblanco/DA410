...
R11 <-cor(sepal.meas)
R22 <-cor(petal.meas)
R12 <-c(cor(sepal.meas[,1], petal.meas[,1]), cor(sepal.meas[,1], petal.meas[,2]),cor(sepal.meas[,2], petal.meas[,1]), cor(sepal.meas[,2], petal.meas[,2]))
...
# u2 = 0.46*Sepal.Length +0.89*Sepal.Width
# v2 =-0.68*Petal.Length -0.73*Petal.Width
...
```
```{r}
cca1 <- cancor(sepal.meas, petal.meas)
